...
{
    /// <summary>
    /// RecipeUpdateDto için FluentValidation validator
    /// </summary>
    public class RecipeUpdateDtoValidator : AbstractValidator<RecipeUpdateDto>
    {
        /// <summary>
        /// RecipeUpdateDtoValidator constructor - validasyon kurallarını tanımlar
        /// </summary>
        public RecipeUpdateDtoValidator()
        {
            RuleFor(x => x.Id)
                .GreaterThan(0).WithMessage("Geçerli bir tarif ID'si gereklidir.");
